...
const BetterSqliteTable = require('./better-sqlite-table.js')
//import BetterSqliteTable from './better-sqlite-table.js';
var emptyRng = []
...
var mainSqlTbl =  new BetterSqliteTable('./', ["w", "fn", "st", "sz"]);
let sqlToStore = ["hello", 34, 10, 14];
mainSqlTbl = insert(sqlToStore);

let sqlresults = mainSqlTbl.select('*');
